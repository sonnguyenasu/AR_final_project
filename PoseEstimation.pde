 ...
 * @param pRot_ rotation as quaternion, both used as output and initial value
 * @param pTrans_ 3-element translation, both used as output and initial value
 ...
 * @return mat : result as 4x4 matrix in row-major format
 */
