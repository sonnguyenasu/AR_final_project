...
class Marker {
    ...
    // Updated (20/05/18), for future implementation
    // **************************************************************
...
class MarkerTracker {
	...
	void findMarker(ArrayList<Marker> markers) {
        ...
        int markerCnt = 0; // Added to display rectified markers (20/05/28)
        ...
        for (MatOfPoint contour : contours) {
            ...
            // modify type of line_parameter for fitLine()
            ...
            // Your Code for Homework 5 (20/05/28) - Start
            // **********************************************
            ...
            // Your Code for Homework 5 (20/05/28) - End
            // **********************************************
